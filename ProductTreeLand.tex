...
\usepackage[paperwidth=223.2cm,paperheight=44.604cm,
...
\node (DBB) [pbox, 
right=6.2cm of DAC] {{\tiny \color{black}.} \newline
\textbf{Data Backbone}
 };
...
\node (QSERV) [pbox,right=15mm of SCICATAR] {{\tiny \color{black}1.02C.06.02.03} \newline
\textbf{Qserv DBMS}
 };
...
\node (SCICATDB) [pbox,below=4pt of QSERV] {{\tiny \color{black}.} \newline
\textbf{Science Cat DBs}
 };
 \draw[pline] (SCICATAR.east) -| ++(0.4,0) |- (SCICATDB.west); 
\node (ALERTDB) [pbox,right=15mm of SCICATDB] {{\tiny \color{black}1.02C.03.03} \newline
\textbf{Alert DB}
 };
 \draw[pline] (SCICATDB.east) -| ++(0.4,0) |- (ALERTDB.west); 
\node (L1DB) [pbox,below=4pt of ALERTDB] {{\tiny \color{black}1.02C.06.01.01} \newline
\textbf{L1 Catalog DB}
 };
...
\node (L2DB) [pbox,below=4pt of L1DB] {{\tiny \color{black}1.02C.06.01.01} \newline
\textbf{L2 Catalog DB}
 };
...
\node (SCIIMGAR) [pbox,below=136pt of SCICATAR] {{\tiny \color{black}.} \newline
\textbf{Science Img Archive}
 };
 \draw[pline] (DBB.east) -| ++(0.4,0) |- (SCIIMGAR.west); 
\node (GMDS) [pbox,right=15mm of SCIIMGAR] {{\tiny \color{black}1.02C.06.02.05} \newline
\textbf{Global Metadata}
 };
 \draw[pline] (SCIIMGAR.east) -| ++(0.4,0) |- (GMDS.west); 
\node (PRVDB) [pbox,below=4pt of GMDS] {{\tiny \color{black}1.02C.06.01.01} \newline
\textbf{Provenance DB}
 };
 \draw[pline] (SCIIMGAR.east) -| ++(0.4,0) |- (PRVDB.west); 
\node (DEVEL) [pbox, 
right=18.6cm of DBB] {{\tiny \color{black}.} \newline
...
\node (INFRA) [pbox, 
right=6.2cm of IDM] {{\tiny \color{black}.} \newline
...
\node (ACTIVATR) [pbox,right=15mm of TXF] {{\tiny \color{black}1.02C.06.03} \newline
\textbf{Activator Bases}
 };
 \draw[pline] (TXF.east) -| ++(0.4,0) |- (ACTIVATR.west); 
\node (CONFIG) [pbox,below=4pt of ACTIVATR] {{\tiny \color{black}1.02C.06.03} \newline
...
\node (LOG) [pbox,below=4pt of CONFIG] {{\tiny \color{black}1.02C.06.04.01} \newline
\textbf{Logging}
 };
\node (LOGpkg) [tbox,below=3mm of LOG.north] {{\tiny \color{black} \begin{verbatim} log \end{verbatim} }  };
 \draw[pline] (TXF.east) -| ++(0.4,0) |- (LOG.west); 
\node (MULTCORE) [pbox,below=4pt of LOG] {{\tiny \color{black}1.02C.06.03} \newline
\textbf{Multi-Core Task}
 };
 \draw[pline] (TXF.east) -| ++(0.4,0) |- (MULTCORE.west); 
\node (MULTNODE) [pbox,below=4pt of MULTCORE] {{\tiny \color{black}1.02C.06.03} \newline
...
\node (SPRTASK) [pbox,below=4pt of MULTNODE] {{\tiny \color{black}1.02C.06.03} \newline
\textbf{SuperTask}
 };
...
\node (INTGTEST) [pbox, 
right=12.4cm of INFRA] {{\tiny \color{black}.} \newline
...
\node (ITENV) [pbox, 
right=6.2cm of INTGTEST] {{\tiny \color{black}.} \newline
...
\node (ITBASE) [pbox,below=306pt of ITARC] {{\tiny \color{black}.} \newline
\textbf{Base IT}
 };
...
\node (L1) [pbox, 
right=12.4cm of ITENV] {{\tiny \color{black}1.02C.03} \newline
...
\node (L1SCI) [pbox,below=238pt of L1ONL] {{\tiny \color{black}.} \newline
\textbf{L1 Science Payloads}
 };
 \draw[pline] (L1.east) -| ++(0.4,0) |- (L1SCI.west); 
\node (APOFFL) [pbox,right=15mm of L1SCI] {{\tiny \color{black}.} \newline
\textbf{Offline Alert Prod}
 };
 \draw[pline] (L1SCI.east) -| ++(0.4,0) |- (APOFFL.west); 
\node (ALRTOFFL) [pbox,right=15mm of APOFFL] {{\tiny \color{black}1.02C.03.03} \newline
\textbf{Offline Alert Gen}
 };
 \draw[pline] (APOFFL.east) -| ++(0.4,0) |- (ALRTOFFL.west); 
\node (MOPS) [pbox,below=4pt of ALRTOFFL] {{\tiny \color{black}1.02C.03.06} \newline
\textbf{Moving Object}
 };
...
\node (PRECOV) [pbox,below=4pt of MOPS] {{\tiny \color{black}1.02C.03.04} \newline
\textbf{Precovery}
 };
 \draw[pline] (APOFFL.east) -| ++(0.4,0) |- (PRECOV.west); 
\node (SFPOFFL) [pbox,below=4pt of PRECOV] {{\tiny \color{black}1.02C.03.01} \newline
\textbf{Offline SFP}
 };
 \draw[pline] (APOFFL.east) -| ++(0.4,0) |- (SFPOFFL.west); 
\node (APPRMPT) [pbox,below=102pt of APOFFL] {{\tiny \color{black}.} \newline
\textbf{Prompt Alert Prod}
 };
 \draw[pline] (L1SCI.east) -| ++(0.4,0) |- (APPRMPT.west); 
\node (ALERTPIPE) [pbox,right=15mm of APPRMPT] {{\tiny \color{black}1.02C.03.03} \newline
\textbf{Alert Gen Pipe}
 };
 \draw[pline] (APPRMPT.east) -| ++(0.4,0) |- (ALERTPIPE.west); 
\node (SFPPIPE) [pbox,below=4pt of ALERTPIPE] {{\tiny \color{black}1.02C.03.01} \newline
...
\node (AUXTEL) [pbox,below=34pt of APPRMPT] {{\tiny \color{black}1.02C.04.02} \newline
\textbf{Aux Tel Spec Pipe}
 };
 \draw[pline] (L1SCI.east) -| ++(0.4,0) |- (AUXTEL.west); 
\node (CALDAILY) [pbox,below=4pt of AUXTEL] {{\tiny \color{black}1.02C.04.02} \newline
\textbf{Daily Calibration}
 };
 \draw[pline] (L1SCI.east) -| ++(0.4,0) |- (CALDAILY.west); 
\node (CALOFFL) [pbox,below=4pt of CALDAILY] {{\tiny \color{black}1.02C.04.02} \newline
...
\node (CALPRMPT) [pbox,below=4pt of CALOFFL] {{\tiny \color{black}1.02C.04.02} \newline
...
\node (CBPCTRL) [pbox,below=4pt of CALPRMPT] {{\tiny \color{black}1.02C.04.02} \newline
\textbf{CBP Control}
 };
 \draw[pline] (L1SCI.east) -| ++(0.4,0) |- (CBPCTRL.west); 
\node (L1QC) [pbox,below=4pt of CBPCTRL] {{\tiny \color{black}1.02C.03} \newline
\textbf{L1 Quality Control}
 };
 \draw[pline] (L1SCI.east) -| ++(0.4,0) |- (L1QC.west); 
\node (L1SRV) [pbox,below=374pt of L1SCI] {{\tiny \color{black}.} \newline
\textbf{Level 1 Services}
 };
 \draw[pline] (L1.east) -| ++(0.4,0) |- (L1SRV.west); 
\node (ARCSRV) [pbox,right=15mm of L1SRV] {{\tiny \color{black}.} \newline
...
\node (PRMPTSRV) [pbox,below=4pt of POINTSRV] {{\tiny \color{black}.} \newline
...
\node (L2) [pbox, 
right=18.6cm of L1] {{\tiny \color{black}.} \newline
...
\node (CPPQC) [pbox,right=15mm of L2SCI] {{\tiny \color{black}1.02C.04.02} \newline
\textbf{CPP Quality Control}
 };
 \draw[pline] (L2SCI.east) -| ++(0.4,0) |- (CPPQC.west); 
\node (CPPSLOW) [pbox,below=4pt of CPPQC] {{\tiny \color{black}1.02C.04.02} \newline
\textbf{Periodic Cal Prod}
 };
 \draw[pline] (L2SCI.east) -| ++(0.4,0) |- (CPPSLOW.west); 
\node (CPPYEAR) [pbox,below=4pt of CPPSLOW] {{\tiny \color{black}1.02C.04.02} \newline
\textbf{Annual Cal Prod}
 };
 \draw[pline] (L2SCI.east) -| ++(0.4,0) |- (CPPYEAR.west); 
\node (DRP) [pbox,below=4pt of CPPYEAR] {{\tiny \color{black}.} \newline
\textbf{Data Release Prod}
 };
 \draw[pline] (L2SCI.east) -| ++(0.4,0) |- (DRP.west); 
\node (COADPIPE) [pbox,right=15mm of DRP] {{\tiny \color{black}1.02C.04.04} \newline
...
\node (COADPROC) [pbox,below=4pt of COADPIPE] {{\tiny \color{black}1.02C.04.05} \newline
...
\node (DRPPOST) [pbox,below=4pt of COADPROC] {{\tiny \color{black}1.02C.04.06} \newline
\textbf{DRP Postprocessing}
 };
 \draw[pline] (DRP.east) -| ++(0.4,0) |- (DRPPOST.west); 
\node (IMGCHAR) [pbox,below=4pt of DRPPOST] {{\tiny \color{black}1.02C.04.03} \newline
...
\node (MULTIFIT) [pbox,below=4pt of IMGCHAR] {{\tiny \color{black}1.02C.04.06} \newline
\textbf{Object Char}
 };
 \draw[pline] (DRP.east) -| ++(0.4,0) |- (MULTIFIT.west); 
\node (OVERLAP) [pbox,below=4pt of MULTIFIT] {{\tiny \color{black}1.02C.04.05} \newline
\textbf{Overlap Resolution}
 };
 \draw[pline] (DRP.east) -| ++(0.4,0) |- (OVERLAP.west); 
\node (DRPDB) [pbox,below=170pt of DRP] {{\tiny \color{black}1.02C.06.01.01} \newline
...
\node (TMPLGEN) [pbox,below=4pt of DRPDB] {{\tiny \color{black}1.02C.03.04} \newline
\textbf{Template Gen Prod}
 };
 \draw[pline] (L2SCI.east) -| ++(0.4,0) |- (TMPLGEN.west); 
\node (PRODEX) [pbox,below=340pt of L2SCI] {{\tiny \color{black}.} \newline
...
\node (LSP) [pbox, 
right=18.6cm of L2] {{\tiny \color{black}.} \newline
...
\node (JLACTIV) [pbox,right=15mm of LSPJL] {{\tiny \color{black}1.02C.10.02.02.05} \newline
\textbf{JupyterLab Activator}
 };
 \draw[pline] (LSPJL.east) -| ++(0.4,0) |- (JLACTIV.west); 
\node (JLDPLY) [pbox,below=4pt of JLACTIV] {{\tiny \color{black}1.02C.10.02.02.06} \newline
\textbf{JupyterLab Deploy}
 };
 \draw[pline] (LSPJL.east) -| ++(0.4,0) |- (JLDPLY.west); 
\node (JLENV) [pbox,below=4pt of JLDPLY] {{\tiny \color{black}1.02C.10.02.02.01} \newline
\textbf{JupyterLab Env}
 };
 \draw[pline] (LSPJL.east) -| ++(0.4,0) |- (JLENV.west); 
\node (JLSUIT) [pbox,below=4pt of JLENV] {{\tiny \color{black}1.02C.05.07} \newline
\textbf{JupyterLab SUIT Intf}
 };
 \draw[pline] (LSPJL.east) -| ++(0.4,0) |- (JLSUIT.west); 
\node (JLSW) [pbox,below=4pt of JLSUIT] {{\tiny \color{black}1.02C.10.02.02.04} \newline
\textbf{JupyterLab SW Env}
 };
 \draw[pline] (LSPJL.east) -| ++(0.4,0) |- (JLSW.west); 
\node (LSPPRTL) [pbox,below=136pt of LSPJL] {{\tiny \color{black}.} \newline
\textbf{LSP Portal}
 };
 \draw[pline] (LSP.east) -| ++(0.4,0) |- (LSPPRTL.west); 
\node (FFLYAPI) [pbox,right=15mm of LSPPRTL] {{\tiny \color{black}1.02C.05.07} \newline
...
\node (FIREFLY) [pbox,below=4pt of FFLYAPI] {{\tiny \color{black}1.02C.05.06 } \newline
\textbf{Firefly}
 };
...
\node (PRTLALRT) [pbox,below=4pt of FIREFLY] {{\tiny \color{black}1.02C.05.09} \newline
\textbf{SUI Alert Interfaces}
 };
 \draw[pline] (LSPPRTL.east) -| ++(0.4,0) |- (PRTLALRT.west); 
\node (PRTLAPPS) [pbox,below=4pt of PRTLALRT] {{\tiny \color{black}1.02C.05.08} \newline
\textbf{Portal Applications}
 };
 \draw[pline] (LSPPRTL.east) -| ++(0.4,0) |- (PRTLAPPS.west); 
\node (PRTLINTF) [pbox,below=4pt of PRTLAPPS] {{\tiny \color{black} user workspace} \newline
...
\node (PRTLVIS) [pbox,below=4pt of PRTLINTF] {{\tiny \color{black}1.02C.05.07} \newline
\textbf{Visualizers}
 };
 \draw[pline] (LSPPRTL.east) -| ++(0.4,0) |- (PRTLVIS.west); 
\node (LSPWEB) [pbox,below=170pt of LSPPRTL] {{\tiny \color{black}.} \newline
\textbf{LSP Web APIs}
 };
 \draw[pline] (LSP.east) -| ++(0.4,0) |- (LSPWEB.west); 
\node (DAXCAT) [pbox,right=15mm of LSPWEB] {{\tiny \color{black}1.02C.06.02.05} \newline
...
\node (DAXCMETA) [pbox,below=4pt of DAXCAT] {{\tiny \color{black}1.02C.06.02.05} \newline
...
\node (DAXIMETA) [pbox,below=4pt of DAXCMETA] {{\tiny \color{black}1.02C.06.02.05} \newline
...
\node (DAXIMG) [pbox,below=4pt of DAXIMETA] {{\tiny \color{black}1.02C.06.02.04} \newline
\textbf{Image Access}
 };
...
\node (DAXWEB) [pbox,below=4pt of DAXIMG] {{\tiny \color{black}1.02C.06.02.02} \newline
\textbf{Web Framework}
 };
...
\node (NETDM) [pbox, 
right=12.4cm of LSP] {{\tiny \color{black}.} \newline
\textbf{DM Networks}
 };
...
\node (NETCPAG) [pbox,right=15mm of NETCHILE] {{\tiny \color{black}1.02C.08.03.01.03} \newline
\textbf{Summit - AURA}
 };
 \draw[pline] (NETCHILE.east) -| ++(0.4,0) |- (NETCPAG.west); 
\node (NETDWDM) [pbox,below=4pt of NETCPAG] {{\tiny \color{black}1.02C.08.03.01.04} \newline
\textbf{DWDM Equipment}
 };
 \draw[pline] (NETCHILE.east) -| ++(0.4,0) |- (NETDWDM.west); 
\node (NETLSAG) [pbox,below=4pt of NETDWDM] {{\tiny \color{black}1.02C.08.03.01.01A} \newline
\textbf{La Serena - AURA}
 };
 \draw[pline] (NETCHILE.east) -| ++(0.4,0) |- (NETLSAG.west); 
\node (NETLSSCL) [pbox,below=4pt of NETLSAG] {{\tiny \color{black}1.02C.08.03.01.01} \newline
\textbf{La Ser - Santi }
 };
 \draw[pline] (NETCHILE.east) -| ++(0.4,0) |- (NETLSSCL.west); 
\node (NETINTLUS) [pbox,below=102pt of NETCHILE] {{\tiny \color{black}.} \newline
\textbf{Int/US WANs}
 };
 \draw[pline] (NETDM.east) -| ++(0.4,0) |- (NETINTLUS.west); 
\node (NET100G) [pbox,right=15mm of NETINTLUS] {{\tiny \color{black}1.02C.08.03.02.01} \newline
\textbf{SCL - MIA 100 Gbps }
 };
 \draw[pline] (NETINTLUS.east) -| ++(0.4,0) |- (NET100G.west); 
\node (NETMGT) [pbox,below=4pt of NET100G] {{\tiny \color{black}1.02C.08.03.02.02} \newline
\textbf{Network Mgmt}
 };
 \draw[pline] (NETINTLUS.east) -| ++(0.4,0) |- (NETMGT.west); 
\node (NETSPEC) [pbox,below=4pt of NETMGT] {{\tiny \color{black}1.02C.08.03.02.03} \newline
\textbf{SCL - BR Spectrum }
 };
 \draw[pline] (NETINTLUS.east) -| ++(0.4,0) |- (NETSPEC.west); 
\node (NETUSW) [pbox,below=4pt of NETSPEC] {{\tiny \color{black}1.02C.08.03.02.01} \newline
\textbf{US National WAN}
 };
 \draw[pline] (NETINTLUS.east) -| ++(0.4,0) |- (NETUSW.west); 
\node (NETLHN) [pbox,below=102pt of NETINTLUS] {{\tiny \color{black}1.02C.08.03} \newline
\textbf{Long-Haul Nets}
 };
 \draw[pline] (NETDM.east) -| ++(0.4,0) |- (NETLHN.west); 
\node (SCIALG) [pbox, 
right=12.4cm of NETDM] {{\tiny \color{black}.} \newline
...
\node (ATTRIB) [pbox,right=15mm of ORBEP] {{\tiny \color{black}1.02C.03.06} \newline
...
\node (EPHEM) [pbox,below=4pt of ATTRIB] {{\tiny \color{black}1.02C.03.06} \newline
...
\node (ORBFIT) [pbox,below=4pt of EPHEM] {{\tiny \color{black}1.02C.03.06} \newline
\textbf{Orbit Fitting}
 };
 \draw[pline] (ORBEP.east) -| ++(0.4,0) |- (ORBFIT.west); 
\node (ORBMERGE) [pbox,below=4pt of ORBFIT] {{\tiny \color{black}1.02C.03.06} \newline
\textbf{Orbit Merging}
 };
 \draw[pline] (ORBEP.east) -| ++(0.4,0) |- (ORBMERGE.west); 
\node (TRACKLET) [pbox,below=4pt of ORBMERGE] {{\tiny \color{black}1.02C.03.06} \newline
\textbf{Tracklet Gen}
 };
...
\node (PHOTOM) [pbox,below=136pt of ORBEP] {{\tiny \color{black}1.02C.03.07} \newline
...
\node (SCIPRIM) [pbox, 
right=12.4cm of SCIALG] {{\tiny \color{black}.} \newline
...
\node (CARTGEOM) [pbox,right=15mm of GEOM] {{\tiny \color{black}1.02C.03.05} \newline
\textbf{Cartesian Geom}
 };
 \draw[pline] (GEOM.east) -| ++(0.4,0) |- (CARTGEOM.west); 
\node (COORD) [pbox,below=4pt of CARTGEOM] {{\tiny \color{black}1.02C.03.05} \newline
...
\node (SPHGEOM) [pbox,below=4pt of COORD] {{\tiny \color{black}1.02C.06.04.03} \newline
...
\node (IMAGE) [pbox,below=68pt of GEOM] {{\tiny \color{black}1.02C.04.01} \newline
\textbf{Images}
 };
...
\node (SQUASH) [pbox, 
right=12.4cm of SCIPRIM] {{\tiny \color{black}.} \newline
\textbf{QC Dashboard}
 };
