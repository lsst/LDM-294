...
{\bf Need a DOC tree for End User Documentation - Johnathon ?}
...
An LSST document class for LaTeX is provided for TeX documents, to use this texmf must be set up to include the texmf folder from the repository. See \url{https://github.com/lsst/lsst-texmf/} to set this up. 
