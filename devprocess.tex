...
\citeds{DMTN-020} describes in detail the integration of \gls{DM}'s agile approach to software development with the \gls{Earned Value} Management system used by the \gls{LSST} construction project.
