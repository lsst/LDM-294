...
\item Responsibilities
	...
	\item Reviews and approves/rejects proposed changes to baselined items
        \item Overviews the release process, approves new or unplanned releases and approves the content of the releases
        \item Reviews and approves all RFCs prior to 'Adoption'
        \item Monitors DM Jira issues status
	\end{itemize}
\end{itemize}

The DM-CCB will meet, physically or virtually, every week. Agenda will be available beforehand.
