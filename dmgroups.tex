...
\item Perform releases of products such as pipelines software as needed using tooling provided by SQuARE (\secref{sect:square}.Debug any build problems related to the product (as opposed to the tooling).
\end{itemize}
