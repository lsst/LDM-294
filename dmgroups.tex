...
\item Responsibilities:
	\begin{itemize}
	\item Determine when specification and deliverables are of sufficient maturity and quality to be baselined (placed under configuration controlled status) or released.
