...
\begin{itemize}
\item Allow the Project manager and DM Scientist  to pass on important project level information and general guidence. 
\item Raise any blocking or not well understood issues across DM - this may result in caling a splinter meeting to further discuss with rlevant parties.
...
Face to Face meetings of DM are held two times a year these are oppertunites to:
\begin{itemize}
\item Discuss detailed planning for the next cycle
\item Discuss technical topics in a face to face enviroment
\item Work together on critical issues
\item Help make DM funtion as a team
\end{itemize}
