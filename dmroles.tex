...
As such, they have primary responsibility for planning, executing and analysing the results of science validation activities, as defined in \citeds{LDM-503}; typically, this includes large-scale data challenges.
The Science Validation Scientist is responsible to the DM Subsystem Scientist.
