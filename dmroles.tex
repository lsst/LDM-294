...
The product owner for the platform is the \gls{DMSS} \secref{role:dmps} with final say on requirements and features, however since this is a vital tool for \gls{LSST} science we feel it is also important to have a scientist considering the platform as a whole.
...
At time od writting Tim Jenness is the Middleware Manager and Robert Gruendl is the Middleware Product owner.
