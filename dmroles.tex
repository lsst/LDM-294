...
They should provide a schedule for the activities and synchronize it withe the other TCAMS.
...
Hence this is  a slightly more coordination oriented role.
\subsubsection{LSP Lead} \label{role:lsp:lead}
\subsubsection{Middleware Lead}
