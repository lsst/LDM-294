...
\begin{itemize}
  ...
  data products, data provenance, and other associated metadata within the LSST Data Acess Centers;}

  \item{Provides implementations of data access services (including IVOA services), as well as associated
  client libraries, to be hosted within the LSST Data Access Centers, which facilitate interraction between
  ...
  abstract interaction between in-memory Python objects and generic persisted archives of those objects;}
