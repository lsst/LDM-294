...
The DM Project Manager (William O'Mullane), Deputy Project Manager (John Swinbank) and DM Project Scientist (Mario Juri\'c), who are known collectively as DM Management, lead the DM Subsystem.
...
The Project Scientist has primary scientific and technical responsibility in the DM and responsibility for ensuring that the scientific requirements of the LSST are supported, and is a member of the LSST Project Science Team (PST).
...
Members of the group will be agreed by the DMLT (\S\ref{sect:dmlt}) to provide the best technical input from the perspective of all stakeholders.
...
DM documents will follow the Systems Engineering Guidelines of LSST. PDF versions of released documents shall be put in DocuShare in accordance with the Project's Document Management Plan \citedsp{LPM-51}.

LDM-level documents are change-controlled, and may be released only on agreement of the DMCCB (\secref{sect:dmccb}). Uncontrolled documents, such as technical notes, may be released when the author decides it is appropriate or they are asked to release it by the Project Manager.
