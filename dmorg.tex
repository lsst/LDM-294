...
\figref{fig:doctree} has one box for End User documentation, this is a major set of documentation for DM which will be web based as  described in  \citeds{LDM-493}. \figref{fig:eudocs} shows the intended web hierarchy for  the end user documentation.

\begin{figure}
\begin{center}
 \includegraphics[width=0.8\textwidth]{images/EndUserDocs}
...
The sizing model for compute hardware purchasing is detailed in \citeds{LDM-151} and \citeds{LDM-181}.
