...
Our primary guiding requirements come from \citeds{LSE-30}, with \appref{sect:tracefor} tracing DM requirements \citedsp{LSE-61} to OSS, and \appref{sect:traceback} tracing the relevant OSS requirements to DM.
...
\figref{fig:prods}
 ...
 Since the figure stops at level 3 most git repositories will only be found in full list in\appref{sect:prodlist}.
