...
Finally when epics are closed the T/CAM should ensure the deliverables are mentioned/linked in the closure in Jira. The DMPM shall verify all closed epics have the defined deliverables associated with them.
